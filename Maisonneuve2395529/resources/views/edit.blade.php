        ...
        <div class="card">
            ...
            <div class="card-body">
                <form method="post">
                    ...
                    <div class="mb-3">
                       <label for="adresse" class="form-label">Adresse</label>        <!-- pour conserver les champs si erreurs -->
                    ...
                    <div class="mb-3">
                       <label for="telephone" class="form-label">telephone</label>        <!-- pour conserver les champs si erreurs -->
                    ...
                    <div class="mb-3">
                       <label for="email" class="form-label">email</label>        <!-- pour conserver les champs si erreurs -->
